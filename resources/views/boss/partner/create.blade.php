...
@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Thêm đối tác</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('boss.partner.store') }}" method="post">
            @csrf
            <div class="card-body">
                ...
                <div class="">
                    <div class="custom-control custom-checkbox mb-2">
                        ...
                        <input type="text" style="display: none" id="NCCText" name="NCC" @if (old('NCC')) value="{{ old('NCC') }}" @else value="0" @endif>
                    ...
                    <div class="custom-control custom-checkbox mb-2">
                        ...
                        <input type="text" style="display: none" id="NMText" name="NM" @if (old('NM')) value="{{ old('NM') }}" @else value="0" @endif>
                    ...
                    <div class="custom-control custom-checkbox mb-2">
                        ...
                        <input type="text" style="display: none" id="car_ownerText" name="car_owner"
                            @if (old('car_owner')) value="{{ old('car_owner') }}" @else value="0" @endif>
