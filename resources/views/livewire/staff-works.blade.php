<div class="container-fluid h-100 ">
        ...
        <div class="card-body">
            @if ($todayDoingSchedules->count() > 0)
                @foreach ($todayDoingSchedules as $todayDoingSchedule)
                            ...
                            <div class="d-flex justify-content-between">
                                {{-- <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input"
                                        id="customSwitch{{ $todayDoingSchedule->id }}" @if ($todayDoingSchedule->status == 0) checked @endif
                                        onclick='handleClick(this);' value='1'>
                                    <label class="custom-control-label"
                                        for="customSwitch{{ $todayDoingSchedule->id }}">Hoàn thành</label>
                                </div> --}}
                                <div>
                                ...
                                <div><a href="#"
                                        class="btn btn-tool btn-link">#{{ $todayDoingSchedule->schedule_details->count() }}</a>
                    ...
                    @if (true)
                        <div class="modal fade" id="exampleModal{{ $todayDoingSchedule->id }}" 
                                                ...
                                                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                                    ...
                                                    <li class="nav-item" >
                                                        <a @class(['nav-link', 'active' => $activeCost])
                                                            ...
                                                            aria-selected="false"
                                                            wire:click="changeTab">Chí phí({{$todayDoingSchedule->cost_details->count()}})</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="card-body">
                                                    ...
                                                    <div @class([
                                                        ...
                                                        <div class="card">
                                                            <div class="card-header" id="headingTwo">
                                                                <h5 class="mb-0">
                                                                    <button class="btn btn-info btn-sm collapsed"
                                                                            ...
                                                                            <tr data-widget="expandable-table"
                                                                                ...
                                                                                <td class="text-right">
                                                                                    ...
                                                                                    <a class="btn btn-info btn-sm"
                                                                                        href="javascript:void(0)"  wire:click="editScheDeatail({{$schedule_detail}})">
                                                                                        <i class="fas fa-pencil-alt">
                                                                                        </i>
                                                                                        Edit
                                                                                    </a >
                                                                                    <a class="btn btn-danger btn-sm btndelete"
                                                                                        href="javascript:void(0)" onclick="handleDeleteScheDetail({{$schedule_detail->id}});">
                                                    ...
                                                    <div @class([
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div id="collapseTwo{{ $todayDoingSchedule->id }}"
                                                                @class(['d-none' => !$showAddForm])
                                                                aria-labelledby="headingTwo{{ $todayDoingSchedule->id }}">
                                                                @livewire('cost-detail-add-form',['todayDoingSchedule'=> $todayDoingSchedule])
                                                            </div>
                                                        </div>
                                                        {{-- end add form --}}
                                                        <div class="card">
                                                                        ...
                                                                        @foreach ($todayDoingSchedule->cost_details as $cost_detail)
                                                                            <tr data-widget="expandable-table"
                                                                                ...
                                                                                <td class="text-right">
                                                                                    ...
                                                                                    <a class="btn btn-danger btn-sm btndelete"
                                                                                        href="javascript:void(0)" onclick="handleDeleteCostDetail({{$cost_detail->id}});">
                                                                                        <i class="fas fa-trash">
                                                                                        </i>
                                                                                        Delete
                                                                                    </a>
        ...
        <div class="card-body">
            @if ($todayCompltedSchedules->count() > 0)
                @foreach ($todayCompltedSchedules as $todayCompltedSchedule)
                    <div @class([
                        ...
                        <div class="card-header">
                            ...
                            <div class="  d-flex justify-content-between">
                                {{-- <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input"
                                        id="customSwitch{{ $todayCompltedSchedule->id }}" @if ($todayCompltedSchedule->status == 0) checked @endif
                                        disabled>
                                    <label class="custom-control-label"
                                        for="customSwitch{{ $todayCompltedSchedule->id }}">Hoàn thành</label>
                                </div> --}}
                                <span class="badge badge-success">
                                    Đã hoàn thành</span>
                                {{-- <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" type="checkbox"
                                    id="customCheckbox{{ $todayCompltedSchedule->id }}" disabled>
                                <label for="customCheckbox{{ $todayCompltedSchedule->id }}"
                                    class="custom-control-label" @if ($todayCompltedSchedule->status == 0) checked @endif>Hoàn
                                    thành</label>
                            </div> --}}
                                <div><a href="#"
                                        class="btn btn-tool btn-link">#{{ $todayCompltedSchedule->schedule_details->count() }}</a>
                    ...
                    <div class="modal fade" id="exampleModal{{ $todayCompltedSchedule->id }}" 
                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <button class="btn btn-success btn-xs"
                                        onclick='handleClick({{ $todayCompltedSchedule->id }});' disabled>Hoàn
                                        thành</button>
                                </div>
                                <div class="modal-footer">
            ...
            @if ($inQueueSchedules->count() > 0)
                @foreach ($inQueueSchedules as $inQueueSchedule)
                    <div @class([
                        ...
                        'text-muted',
                        'card-outline',
                        'card-secondary' => $inQueueSchedule->date > Carbon\Carbon::today(),
                        'card-info' => $inQueueSchedule->date < Carbon\Carbon::today(),
                    ])>
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class=" d-flex justify-content-between">
                                ...
                                @else
                                    {{-- <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input"
                                            id="customSwitch{{ $inQueueSchedule->id }}" @if ($inQueueSchedule->status == 0) checked @endif
                                            disabled>
                                        <label class="custom-control-label"
                                            for="customSwitch{{ $inQueueSchedule->id }}">Hoàn
                                            thành</label>
                                    </div> --}}
                                ...
                                {{-- <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" type="checkbox"
                                    id="customCheckbox{{ $inQueueSchedule->id }}" disabled>
                                <label for="customCheckbox{{ $inQueueSchedule->id }}"
                                    class="custom-control-label">Hoàn
                                    thành</label>
                            </div> --}}
                                <div><a href="#"
                                        class="btn btn-tool btn-link">#{{ $inQueueSchedule->schedule_details->count() }}</a>
                                    {{-- <a href="#" class="btn btn-tool">
                                        <i class="fas fa-info"></i>
                                    </a> --}}
                                    <a href="#" class="btn btn-tool" data-toggle="modal"
                                        data-target="#exampleModal{{ $inQueueSchedule->id }}">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="modal fade" id="exampleModal{{ $inQueueSchedule->id }}"
    ...
    <div class="modal fade" id="exampleModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">@if($editingScheDetail){{$editingScheDetail['id']}} @endif </h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <input type="text" wire:model="editingScheDetail.id">
            </div>
            <div class="modal-footer">
